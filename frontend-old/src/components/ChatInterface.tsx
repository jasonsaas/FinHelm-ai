...
const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  // Process chat history when data changes
  useEffect(() => {
    if (chatHistory?.messages) {
      const formattedMessages: Message[] = chatHistory.messages.map((msg: any) => ({
        ...
        charts: msg.message_metadata?.charts || [],
        insights: msg.message_metadata?.insights || {},
        recommendations: msg.message_metadata?.recommendations || []
      }));
